...
namespace Libretro::Options::SettingsManager
{
void InitSettings()
{

  SConfig::GetInstance().bBootToPause = true;
  for (OptionUpdater* option : dolphin_options)
    option->UpdateDolphin();
#if defined(_DEBUG)
...
void PollAndApply()
{
  ...
  if (Libretro::Options::irMode.Updated() || Libretro::Options::irCenter.Updated()
      ...
      || Libretro::Options::enable_rumble.Updated())
  {
