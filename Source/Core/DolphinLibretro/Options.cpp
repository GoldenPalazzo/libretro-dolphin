...
Option<AnisotropicFilteringMode> maxAnisotropy("dolphin_max_anisotropy", "Max Anisotropy", {"1x", "2x", "4x", "8x", "16x"});
...
Option<TextureFilteringMode> forceTextureFiltering("dolphin_force_texture_filtering", "Force Texture Filtering", {"Default", "Nearest", "Linear"});
